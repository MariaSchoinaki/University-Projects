...
class Greedy{
    ...
    public static long s_total_size=0;// Static metablhth gia to sunoliko megethos twn fakelwn gia kathe fora pou tha treksoume thn Greedy.java
    public static int iter=0;// Static metablhth gia to arxeio pou tha diabasoume tous fakelous gia kathe fora pou tha treksoume thn Greedy(args[i])
    public static int s_total_disk=0;//Static metablhth gia to sunoliko arithmo twn diskwn gia kathe fora pou tha treksoume thn Greedy.java

    // ^^^ Oi parapanw metablhtes prostethikan gia to Meros D opou kaloume th Greedy.main(args) (MerosDcompare.java) ^^^
    ...
    public static void main(String []args){
        ...
        if(sunexeia){                                                       // An egine kanonika to diabasma apo to arxeio
            ...
            System.out.println("------ Greedy.java - " + filename + "-----------------" );  //Emfanizetai o algorithmos pou trexoume kai to onoma
            // tou .txt arxeiou pou trexoume
            ...
            // Oi parakatw metablhtes aforoun to Meros D opou kaloume th Greedy.main(args) (MerosDcompare.java)
